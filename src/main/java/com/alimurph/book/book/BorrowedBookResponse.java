...
public class BorrowedBookResponse {
    ...
    public BorrowedBookResponse(Long id, String title, String authorName, String isbn, double rate, boolean returned, boolean returnedApproved) {
        this.id = id;
        this.title = title;
    ...
    public static class Builder {
        ...
        public BorrowedBookResponse createBorrowedBookResponse() {
            return new BorrowedBookResponse(id, title, authorName, isbn, rate, returned, returnedApproved);
        }
    }
}
